...
function QueueVideoCall() {
    ...
    const handleChatButtonClick = () => {
        ...
        let response = axios.get(`localhost:8080/api/patient/getSocketOfDoctor/${x}`);
  ...
  return (
    ...
    <div className='dashboard_container'>
        ...
        <div>
            ...
            <div className='personal_code_connecting_buttons_container hidden'>
