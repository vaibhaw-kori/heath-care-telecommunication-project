...
const Navbar = () => {
  return (
    ...
    <div className="flex flex-col items-center justify-center py-0  mq1025:hidden h-full sticky">
      <div className="flex-1 flex flex-row items-start justify-start sticky">
        ...
        <nav className="m-0 self-stretch sticky h-[1150px] bg-gradient-to-r from-sky-500 to-indigo-500 flex flex-col items-center justify-start py-[193px] pr-[92px] pl-[27px] gap-[33px_0px] text-left text-base text-gray-1100 font-nunito mq750:pt-[125px] mq750:pb-[125px] mq750:box-border ">
          ...
          <div className="flex flex-row items-start justify-start py-0 ">
            ...
            <div className="flex flex-row items-start justify-start py-0 ">
              <div className="flex flex-row items-start justify-start gap-[0px_13px]">
                ...
                />
                <Link to="/appointments" className="relative font-semibold z-[1] no-underline text-black">Calls</Link>
              </div>
            </div>
